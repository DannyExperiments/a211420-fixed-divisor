...
ratio divides its numerator, and hence $a_n\in\mathbb{N}$.
\end{proof}
...
\nolinkurl{A211420.strengthened_cross}. Exact factorial-ratio divisibility is
established by \nolinkurl{A211420.integral_cross} before the natural-number
quotient is introduced, and the quotient identity is then used to derive the
final theorem \nolinkurl{A211420.strengthened}. The repository pins both Lean and
